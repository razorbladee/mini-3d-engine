...
export * from './core/PerformanceMetrics';
...
export * from './geometry/BufferAttribute';
...
export * from './interaction/InputMap';
...
export * from './physics/PhysicsAdapter';
...
export * from './audio/AudioHooks';
export * from './debug/SceneInspector';
